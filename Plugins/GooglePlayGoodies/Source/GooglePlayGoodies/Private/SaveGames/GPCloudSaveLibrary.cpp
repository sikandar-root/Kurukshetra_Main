...
void UGPCloudSaveLibrary::OpenSnapshotWithMetadata(UGPSnapshotMetadata* SnapshotMetadata, EConflictResolutionPolicy ConflictPolicy,
                                                   const FGPOnSnapshotOpenSuccessDelegate& OnSnapshotOpenWithMetadataSuccess,
                                                   const FGPOnErrorDelegate& OnOpenSnapshotWithMetadataError,
                                                   const FGPOnConflictDelegate& OnOpenSnapshotWithMetadataConflict)
{
...
void UGPCloudSaveLibrary::WriteSnapshot(
	UGPSnapshot* Snapshot,
	TArray<uint8> Data,
	UTexture2D* CoverImage,
	const FString& Description,
	int64 PlayedTimeMillis,
	int64 ProgressValue,
	const FGPOnSnapshotMetadataDelegate& OnWriteSnapshotSuccess,
	const FGPOnErrorDelegate& OnWriteSnapshotFailure)
{
...
void UGPCloudSaveLibrary::ReadSnapshot(UGPSnapshot* Snapshot,
                                       const FGPOnSnapshotReadSuccessDelegate& OnSnapshotReadSuccess,
                                       const FGPOnErrorDelegate& OnReadSnapshotFailure)
{
...
void UGPCloudSaveLibrary::GetMaxCoverImageSize(
	const FGPOnGetMaxSizeDelegate& OnGetMaxCoverImageSizeSuccess,
	const FGPOnErrorDelegate& OnGetMaxCoverImageFailure)
{
...
void UGPCloudSaveLibrary::GetMaxDataSize(
	const FGPOnGetMaxSizeDelegate& OnGetMaxDataSizeSuccess,
	const FGPOnErrorDelegate& OnGetMaxDataFailure)
{
...
void UGPCloudSaveLibrary::LoadSnapshotMetadata(bool ForceReload,
                                               const FGPOnLoadSnapshotMetadataDelegate& OnLoadSnapshotMetadata,
                                               const FGPOnErrorDelegate& OnLoadSnapshotMetadataFailure)
{
...
void UGPCloudSaveLibrary::ResolveConflict(const FString& ConflictId, UGPSnapshot* Snapshot,
                                          const FGPOnSnapshotOpenSuccessDelegate& OnResolveConflictSuccess,
                                          const FGPOnErrorDelegate& OnResolveConflictFailure,
                                          const FGPOnConflictDelegate& OnResolveConflictConflict)
{
...
JNI_METHOD void Java_com_ninevastudios_googleplay_GPCloudSaveLibrary_onDeleteSnapshotMetadataSuccessCallback(JNIEnv* env, jclass clazz, jstring deleteMessage)
{
	...
	UE_LOG(LogGooglePlayGoodies, Warning, TEXT("%s"), *DeleteMessage);
