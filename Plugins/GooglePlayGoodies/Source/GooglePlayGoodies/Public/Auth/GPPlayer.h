...
class GOOGLEPLAYGOODIES_API UGPPlayer : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Google Play Goodies|Player")
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|Player")
