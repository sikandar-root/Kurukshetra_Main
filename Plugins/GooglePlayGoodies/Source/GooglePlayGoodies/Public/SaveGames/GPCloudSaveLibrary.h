...
// TODO Document all public API methods, do this everywhere
UCLASS()
class GOOGLEPLAYGOODIES_API UGPCloudSaveLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnAddNewSnapshot, OnViewSnapshotMetadata, OnCancel, OnError"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnSnapshotOpenSuccess,OnOpenSnapshotError,OnOpenSnapshotByFileNameConflict"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnSnapshotOpenWithMetadataSuccess,OnOpenSnapshotWithMetadataError,OnOpenSnapshotWithMetadataConflict"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnWriteSnapshotSuccess, OnWriteSnapshotFailure"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnSnapshotReadSuccess, OnReadSnapshotFailure"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnGetMaxCoverImageSizeSuccess, OnGetMaxCoverImageFailure"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnGetMaxDataSizeSuccess, OnGetMaxDataFailure"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnDeleteSnapshotSuccess, OnDeleteSnapshotFailure"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnLoadSnapshotMetadata, OnLoadSnapshotMetadataFailure"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Google Play Goodies|SaveCloud", meta = (AutoCreateRefTerm = "OnResolveConflictSuccess, OnResolveConflictFailure,OnResolveConflictConflict"))
